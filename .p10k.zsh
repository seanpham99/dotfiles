# Generated by Powerlevel10k configuration wizard on 2026-02-04 at 20:10 +07.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 57870.
# Wizard options: flat, large icons, classic, unicode, dark, 24h time, blurred heads,
# flat tails, 2 lines, solid, full frame, compact, few icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # virtualenv            # moved to left prompt
